    ...
    routes: [
        {
            ...
            children: [
...

                {
                    ...
                    name:'TNN',
                    path: '/TNN',
                    component: () => import(/* webpackChunkName: "markdown" */ '../components/page/TNN.vue'),
                    meta: { title: 'TNN模型' }
                },

                {
                    ...
                    name:'LSTM',
                    path: '/LSTM',
                    component: () => import(/* webpackChunkName: "markdown" */ '../components/page/LSTM.vue'),
                    meta: { title: 'LSTM+AM模型' }
                },
